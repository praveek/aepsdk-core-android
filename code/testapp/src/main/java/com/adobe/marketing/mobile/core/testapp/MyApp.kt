...
class MyApp : Application() {
    ...
    override fun onCreate() {
        ...
        val options = InitOptions.configureWithAppID("APP_ID").apply {
            automaticLifecycleTrackingEnabled = true
            lifecycleAdditionalContextData = mapOf("key1" to "value1")
        }

        MobileCore.setLogLevel(LoggingMode.VERBOSE)
        MobileCore.initializeSDK(this, options) {
